...
namespace Functions2
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine(new LargestInArray().Largest(new int[] { 5, 0, -2, 100, 70, 2 }));
            ...
            Console.WriteLine(new SumNestedForLoop().NestedArray(new int[][] { new int[] { 2, 4, 6 }, new int[] { 3, 5, 7 } }));
